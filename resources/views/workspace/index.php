                            ...
                            <div class="row d-flex justify-content-between align-items-center">
                                ...
                                <div class="header-info-right">
                                    <ul>    
                                        ...
                                        <li><a href="registration.html"><i class="ti-lock"></i>Register</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-xl-6 col-lg-7 col-md-8">
                                <div class="hero__caption">
                                    ...
                                    <h1 data-animation="fadeInLeft" data-delay=".4s">Bienvenue dans votre espace services!</h1>
                                    <!-- Hero-btn -->
                                    <div class="hero__btn">
                                        <a href="login.php" class="btn hero-btn"  data-animation="fadeInLeft" data-delay=".8s"> Login &nbsp</a>
                                        <a href="register.php" class="btn hero-btn"  data-animation="fadeInLeft" data-delay=".8s">Register</a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="single-slider slider-height d-flex align-items-center">
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-xl-6 col-lg-7 col-md-8">
                                <div class="hero__caption">
                                    <span data-animation="fadeInLeft" data-delay=".2s">Nos services </span>
                ...
                <div class="row justify-content-sm-center">
                    <div class="cl-xl-7 col-lg-8 col-md-10">
                        ...
                        <div class="section-tittle text-center mb-70">
                            <span>Informations sur la plateforme</span>
                            <h2>Nos services</h2>
                        </div> 
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat mb-50">
                            ...
                            <div class="cat-cap">
                                <h5><a  href="#">Service de scolarité</a></h5>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-cat mb-50">
                            ...
                            <div class="cat-cap">
                                <h5><a  href="#">Relations extérieures</a></h5>
                                <p>Sorem hpsum folor sixdsft amhtget, consectetur adipiscing eliht, sed do eiusmod tempor incidi.</p>
                                <a  href="#" class="read-more1">Read More ></a>
                            </div>
                        </div>
                ...
                <div class="row justify-content-center">
                    <div class="cl-xl-7 col-lg-8 col-md-10">
                        ...
                        <div class="section-tittle section-tittle2 text-center mb-70">
                            <span>Concernant l'équipe</span>
                            <h2>Nos responsables services</h2>
                        </div> 
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="about-caption mb-50">
                            ...
                            <div class="section-tittle mb-35">
                                <span>Plus sur notre plateforme</span>
                                <h2>A quoi s'agit elle ?</h2>
                            </div>
                            <p>Cette plateforme est une interface numérique dédiée aux étudiants, ainsi qu'aux responsables des services afin de leur faciliter les opérations suivantes:</p>
                            <ul>
                                <li><span class="flaticon-business"></span> Gestion des documents des étudiants</li>
                                <li><span class="flaticon-communications-1"></span> Réservation d'espace et de matériel</li>
                                <li><span class="flaticon-graduated"></span> Demandes de stage</li>
                                <li><span class="flaticon-tools-and-utensils"></span> Demandes des documents</li>
                            </ul>
